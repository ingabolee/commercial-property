    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                    <button onclick="window.location.href='addvehicle.php'" class="btn btn-primary btn-round">Add Vehicle</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_id"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_registration_no"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_brand"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_color"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_current_mileage"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_current_market_price"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_CHasis_no"]?></td>
                                    <td><button onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'" name="submit" class="btn btn-warning btn-round">Edit</button></td>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_id"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_model"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_registration_no"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_brand"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_color"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_current_mileage"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_date_received"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_current_market_price"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_year_of_manufucturing"]?></td>
                                    <td  onclick="window.location.href='editvehicle.php?id=<?php echo $row['Vehicle_id']; ?>'"><?php echo $row["Vehicle_CHasis_no"]?></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
