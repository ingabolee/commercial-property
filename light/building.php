    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                    <button onclick="window.location.href='addbuilding.php'" class="btn btn-primary btn-round">Add Building</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'"><?php echo $row["Building_id"]?></td>
                                    <td  onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'"><?php echo $row["Building_name"]?></td>
                                    <td  onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'"><?php echo $row["Building_physical_location"]?></td>
                                    <td  onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'"><?php echo $row["Building_floor_count"]?></td>
                                    <td  onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'"><?php echo $row["Building_room_count"]?></td>
                                    <td><button onclick="window.location.href='editbuilding.php?id=<?php echo $row['Building_id']; ?>'" name="submit" class="btn btn-warning btn-round">Edit</button></td>
                                    <td><button onclick="window.location.href='deletebuilding.php?id=<?php echo $row['Building_id']; ?>'" class="btn btn-danger btn-round">Delete</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
