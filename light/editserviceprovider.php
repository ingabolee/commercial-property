...
<!-- Mirrored from thememakker.com/templates/oreo/realestate/html/light/property-add.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jul 2021 09:39:36 GMT -->
<head>
<meta charset="utf-8">
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="https://thememakker.com/templates/oreo/realestate/html/assets/images/logo.svg" width="30" alt="Oreo"><span class="m-l-10">Oreo</span></a>
            </div>
        </li>
        <li><a href="javascript:void(0);" class="ls-toggle-btn" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
        <li class="hidden-md-down"><a href="events.php" title="Events"><i class="zmdi zmdi-calendar"></i></a></li>
        <li class="hidden-md-down"><a href="mail-inbox.php" title="Inbox"><i class="zmdi zmdi-email"></i></a></li>
        <li><a href="contact.php" title="Contact List"><i class="zmdi zmdi-account-box-phone"></i></a></li>
                ...
                <ul class="list">
                    ...
                    <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Property</span></a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="property-list3.php">3 Column</a></li>
                            <li><a href="property-list4.php">4 Column</a></li>
                            <li class="active"><a href="property-add.php">Add Property</a></li>
                            <li><a href="property-detail.php">Property Detail</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-outline"></i><span>Agents</span></a>
                        <ul class="ml-menu">
                            <li><a href="agent.php">All Agents</a></li>
                            <li><a href="add-agent.php">Add Agent</a></li>
                            <li><a href="profile.php">Agent Profile</a></li>
                            <li><a href="invoices.php">Agent Invoice</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-case-check"></i><span>Contract</span></a>
                        <ul class="ml-menu">
                            <li><a href="contract-add.php">Add New</a></li>
                            <li><a href="contract-list.php">List</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>App</span></a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="blog-dashboard.php">Blog</a></li>
                        </ul>
                    </li>
                    <li><a href="groups.php"><i class="zmdi zmdi-ungroup"></i><span>Groups</span></a>
                    <li><a href="file-dashboard.php"><i class="zmdi zmdi-file-text"></i><span>File Manager</span></a>
                    <li><a href="jvectormap.php"><i class="zmdi zmdi-map"></i><span>Site Location</span></a>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li><a href="c3chart.php">C3 Chart</a></li>
