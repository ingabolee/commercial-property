...
if(isset($_POST['submit'])){
    ...
    $Land_Property_type_id = $_POST['Land_Property_type_id'];

    $sql = "INSERT INTO land (Land_longitudes, Land_Latitudes, Land_current_market_price, Land_physical_location, Land_nearest_landmark, Land_Size, Land_Title_no, Land_Owner_id, Land_Property_type_id) 
                VALUES ('$Land_longitudes', '$Land_Latitudes', '$Land_current_market_price', '$Land_physical_location', '$Land_nearest_landmark', '$Land_Size', '$Land_Title_no', '$Land_Owner_id', '$Land_Property_type_id')";
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Longitudes" name="Land_longitudes">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Latitudes" name="Land_Latitudes">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Market Price" name="Land_current_market_price">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Physical Location" name="Land_physical_location">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Nearest Landmark" name="Land_nearest_landmark">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Land Size in acres" name="Land_Size">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Title Number" name="Land_Title_no">
                                </div>
                            </div>
                            ...
                            <h6 class="mt-4">Owner</h6><br>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Owner_id']; ?>" name="Land_Owner_id" value="<?php echo $row['Owner_id']; ?>">
                            ...
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Property_type_id']; ?>" name="Land_Property_type_id" value="<?php echo $row['Property_type_id']; ?>">
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Add Land</button>
