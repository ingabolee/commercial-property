    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <h2>Add Service<small>eg. Inspection, Insurance</small>
                </h2>
            </div>            
                ...
                <div class="card">
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <textarea name="Service_desc" id="description" cols="30" rows="5" class="form-control" placeholder="Description"></textarea>
                                </div>
                            </div>
                            
                            <div class="col-sm-12">
                                    <button type="submit" name="submit" class="btn btn-primary btn-round">Add Service</button>
