                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td><?php echo $row["Provider_company_name"]?></td>
                                    <td><?php echo $row["Provider_contact_person"]?></td>
                                    <td><?php echo $row["Provider_email"]?></td>
                                    <td><?php echo $row["Provider_mobile_no"]?></td>
                                    <td><?php echo $row["Provider_location"]?></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
