...
if(isset($_POST['submit'])){
    ...
    $Valuation_Machinery_id = $_POST['Valuation_Machinery_id'];
    $Valuation_report = $_POST['Valuation_report'];

    $sql = "INSERT INTO property_valuation (Valuation_Provider_id, Valuation_Property_type_id, Valuation_Machinery_id, Valuation_report) 
                VALUES ('$Valuation_Provider_id', '$Valuation_Property_type_id', '$Valuation_Machinery_id', '$Valuation_report')";
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Machinery_id']; ?>" name="Valuation_Machinery_id" value="<?php echo $row['Machinery_id']; ?>">
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Confirm Machinery Valuation</button>
