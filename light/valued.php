...
$sql = "SELECT * FROM property_valuation";
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td ><?php echo $row["Valuation_id"]?></td>
                                    <td ><?php echo $row["Valuation_date"]?></td>
                                    <td ><?php echo $row["Valuation_report"]?></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
