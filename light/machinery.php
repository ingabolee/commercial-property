    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                    <button onclick="window.location.href='addmachinery.php'" class="btn btn-primary btn-round">Add Machinery</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_id"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_name"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_acquisition_date"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_inspection_date"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_purpose"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_Ref_no"]?></td>
                                    <td><button onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'" name="submit" class="btn btn-warning btn-round">Edit</button></td>
                                    <td><button onclick="window.location.href='deletemachinery.php?id=<?php echo $row['Machinery_id']; ?>'" class="btn btn-danger btn-round">Delete</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable  js-exportable">
                            ...
                            <tr>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_purpose"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_Ref_no"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_manufucturer"]?></td>
                                    <td  onclick="window.location.href='editmachinery.php?id=<?php echo $row['Machinery_id']; ?>'"><?php echo $row["Machinery_year_of_manufucturing"]?></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
