...
if(isset($_POST['submit'])){
    $Inspection_Provider_id = $_POST['Inspection_Provider_id'];
    $Inspection_Property_type_id = $_POST['Inspection_Property_type_id'];
    $Inspection_Machinery_id = $_POST['Inspection_Machinery_id'];
    $Inspection_report = $_POST['Inspection_report'];

    $sql = "INSERT INTO property_inspection (Inspection_Provider_id, Inspection_Property_type_id, Inspection_Machinery_id, Inspection_report) 
                VALUES ('$Inspection_Provider_id', '$Inspection_Property_type_id', '$Inspection_Machinery_id', '$Inspection_report')";

    $result = mysqli_query($conn, $sql);
    if ($result){

        header ("Location: inspected.php");
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <h6 class="mt-4">Provider</h6><br>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Provider_id']; ?>" name="Inspection_Provider_id" value="<?php echo $row['Provider_id']; ?>">
                            ...
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Property_type_id']; ?>" name="Inspection_Property_type_id" value="<?php echo $row['Property_type_id']; ?>">
                            ...
                            ?>
                            <div class="float-right">
                            <h6 class="mt-4">Machinery</h6><br>
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Machinery_id']; ?>" name="Inspection_Machinery_id" value="<?php echo $row['Machinery_id']; ?>">
                                        <label for="<?php echo $row['Machinery_id']; ?>"><?php echo $row['Machinery_name']; ?></label>
                                    </div>
                                    <?php  endwhile; ?> 
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group">
                                        <textarea name="Inspection_report"  cols="30" rows="5" class="form-control" placeholder="Inspection Report"></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Confirm Machinery Inspection</button>
