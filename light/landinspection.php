...
if(isset($_POST['submit'])){
    ...
    $Inspection_Land_id = $_POST['Inspection_Land_id'];
    $Inspection_report = $_POST['Inspection_report'];

    $sql = "INSERT INTO property_inspection (Inspection_Provider_id, Inspection_Property_type_id, Inspection_Land_id, Inspection_report) 
                VALUES ('$Inspection_Provider_id', '$Inspection_Property_type_id', '$Inspection_Land_id', '$Inspection_report')";
                ...
                <div class="card">
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            ?>
                            <div class="float-right">
                            <h6 class="mt-4">Land</h6><br>
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Land_id']; ?>" name="Inspection_Land_id" value="<?php echo $row['Land_id']; ?>">
                                        <label for="<?php echo $row['Land_id']; ?>"><?php echo $row['Land_physical_location']; ?></label>
                                    </div>
                                    <?php  endwhile; ?> 
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Confirm Land Inspection</button>
