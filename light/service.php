                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editservice.php?id=<?php echo $row['Service_id']; ?>'"><?php echo $row["Service_id"]?></td>
                                    <td  onclick="window.location.href='editservice.php?id=<?php echo $row['Service_id']; ?>'"><?php echo $row["Service_name"]?></td>
                                    <td  onclick="window.location.href='editservice.php?id=<?php echo $row['Service_id']; ?>'"><?php echo $row["Service_desc"]?></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
