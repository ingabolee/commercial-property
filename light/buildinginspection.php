...
if(isset($_POST['submit'])){
    ...
    $Inspection_Building_id = $_POST['Inspection_Building_id'];
    $Inspection_report = $_POST['Inspection_report'];

    $sql = "INSERT INTO property_inspection (Inspection_Provider_id, Inspection_Property_type_id, Inspection_Building_id, Inspection_report) 
                VALUES ('$Inspection_Provider_id', '$Inspection_Property_type_id', '$Inspection_Building_id', '$Inspection_report')";
                ...
                <div class="card">
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            ?>
                            <div class="float-right">
                            <h6 class="mt-4">Building</h6><br>
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Building_id']; ?>" name="Inspection_Building_id" value="<?php echo $row['Building_id']; ?>">
                                        <label for="<?php echo $row['Building_id']; ?>"><?php echo $row['Building_name']; ?></label>
                                    </div>
                                    <?php  endwhile; ?> 
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Confirm Building Inspection</button>
