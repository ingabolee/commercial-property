...
if(isset($_POST['submit'])){
    ...
    $Property_type_desc = $_POST['Property_type_desc'];

    $sql = "UPDATE property_type SET Property_type_name = '$Property_type_name', Property_type_desc = '$Property_type_desc' WHERE Property_type_id = '$Property_type_id'"; 
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name='Property_type_name' value="<?php echo $row['Property_type_name'];?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <textarea name='Property_type_desc' cols="30" rows="5" class="form-control" value=""><?php echo $row['Property_type_desc'];?></textarea>
                                    </div>
                                </div>
                                
                                <div class="col-sm-12">
                                    <button name="submit" class="btn btn-primary btn-round">Edit Property Type</button>
                                    <a  href="deletepropertytype.php?id=<?php echo $Property_type_id ?>" class="btn btn-danger btn-round ">Delete</a>
                                    <a href="propertytype.php" class="btn btn-default btn-round btn-simple">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
