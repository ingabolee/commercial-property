...
if(isset($_POST['submit'])){
    ...
    $Inspection_Vehicle_id = $_POST['Inspection_Vehicle_id'];
    $Inspection_report = $_POST['Inspection_report'];

    $sql = "INSERT INTO property_inspection (Inspection_Provider_id, Inspection_Property_type_id, Inspection_Vehicle_id, Inspection_report) 
                VALUES ('$Inspection_Provider_id', '$Inspection_Property_type_id', '$Inspection_Vehicle_id', '$Inspection_report')";
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-8">
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" id="<?php echo $row['Vehicle_id']; ?>" name="Inspection_Vehicle_id" value="<?php echo $row['Vehicle_id']; ?>">
                        ...
                        <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary btn-round">Confirm Vehicle Inspection</button>
